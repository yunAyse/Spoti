           ...
           <div class="image pt-3" style="width: 250px; height: 250px; object-fit: cover;">
                ...
                <div class="controls w-100">
                    <div class="bp d-flex align-items-center justify-content-around">
                        ...
                        <button class="shuffle border-0 rounded-circle " style="background-color: #252229"><svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="#1ED760" class="bi bi-shuffle" viewBox="0 0 16 16">
